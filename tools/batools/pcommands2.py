...
def gen_builtin_asset_ids() -> None:
    ...
    writes src/ballistica/base/generated/builtin_asset_ids.h and
    src/ballistica/base/generated/builtin_asset_load.inc. Pass
    ``--check`` to fail (without writing) if outputs are out of date.
    """
    from pathlib import Path
    from batools.builtinassetids import generate

    check = '--check' in sys.argv
    # Path.cwd() is unreliable here — codegen-build invokes us from
    # src/codegen/. Use the pcommand-provided projroot which points at
