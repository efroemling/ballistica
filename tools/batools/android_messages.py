...
Reads a spec module (babasecodegen.android_messages) describing typed
...
# project spec under `src/codegen/<featureset>codegen/android_messages.py`.
...
def _load_spec(projroot: str) -> list[Message]:
    ...
    try:
        ...
        if 'babasecodegen.android_messages' in sys.modules:
            importlib.reload(sys.modules['babasecodegen.android_messages'])
        mod = importlib.import_module('babasecodegen.android_messages')
    finally:
        sys.path.pop(0)
...
// Do not edit by hand; see src/codegen/babasecodegen/android_messages.py.

package com.ericfroemling.ballistica.generated;
...
def _emit_cpp_impl(messages: list[Message]) -> str:
    ...
    out.append(
        ...
        '      "com/ericfroemling/ballistica/generated/BallisticaJniBridge");\n'
        '  if (cls == nullptr) {\n'
        '    return JNI_ERR;\n'
        '  }\n'
