...
cmake-binary: meta
	...
	@cd build/cmake/$(CM_BT_LC) && test -f Makefile \
      || cmake -DCMAKE_BUILD_TYPE=$(CMAKE_BUILD_TYPE) $(CMAKE_DEVELOPER_FLAG) \
      $(CMAKE_EXTRA_ARGS) $(shell pwd)/ballisticakit-cmake
...
cmake-server-binary: meta
	...
	@cd build/cmake/server-$(CM_BT_LC) && test -f Makefile \
      || cmake -DCMAKE_BUILD_TYPE=$(CMAKE_BUILD_TYPE) $(CMAKE_DEVELOPER_FLAG) \
      $(CMAKE_EXTRA_ARGS) -DHEADLESS=true $(shell pwd)/ballisticakit-cmake
