...
build_time_vars = {
    ...
    'CONFIGURE_CFLAGS': '-arch arm64 -mmacosx-version-min=11.0 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk',
    ...
    'HAVE___UINT128_T': 1,
    'HOSTRUNNER': '',
    'HOST_GNU_TYPE': 'aarch64-apple-darwin25.3.0',
    ...
    'LIBPL': '/usr/lib/python3.13/config-3.13-darwin',
    'LIBPYTHON': '',
    ...
    'MODULE__CTYPES_CFLAGS': '-fno-strict-overflow -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/ffi -DUSING_APPLE_OS_LIBFFI=1 -DUSING_MALLOC_CLOSURE_DOT_C=1',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/Users/ericf/LocalDocs/ballistica-internal/build/python_apple_macosx_arm64/src/Python-3.13.11 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /Users/ericf/LocalDocs/ballistica-internal/build/python_apple_macosx_arm64/src/Python-3.13.11/`cat pybuilddir.txt`) /Users/ericf/LocalDocs/ballistica-internal/.venv/bin/python3.13',
    ...
    'abs_builddir': '/Users/ericf/LocalDocs/ballistica-internal/build/python_apple_macosx_arm64/src/Python-3.13.11',
    'abs_srcdir': '/Users/ericf/LocalDocs/ballistica-internal/build/python_apple_macosx_arm64/src/Python-3.13.11',
