...
class App:
    ...
    def run_default_imports(self) -> None:
        ...
        try:
          ...
          print(f'Error importing default module bascenev1 with alias bs: {e}')
        try:
          import bascenev1lib as bsl
        except ImportError as e:
          print(f'Error importing default module bascenev1lib with alias bsl: {e}')
        try:
          import bauiv1 as bui
        except ImportError as e:
          print(f'Error importing default module bauiv1 with alias bui: {e}')
        try:
          import bauiv1lib as buil
        except ImportError as e:
          print(f'Error importing default module bauiv1lib with alias buil: {e}')
