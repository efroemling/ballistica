...
class App:
    ...
    def _run_default_imports(self) -> None:
        ...
        # Get the main module namespace to inject imports
        main_module = sys.modules.get('__main__')
        if main_module is None:
            return

        main_dict = vars(main_module)

        # Auto-generated imports from projectconfig
        _mod = importlib.import_module('babase')
        main_dict['babase'] = _mod
        main_dict['ba'] = _mod
        _mod = importlib.import_module('bascenev1')
        main_dict['bascenev1'] = _mod
        main_dict['bs'] = _mod
        _mod = importlib.import_module('bascenev1lib')
        main_dict['bascenev1lib'] = _mod
        main_dict['bs_lib'] = _mod
        _mod = importlib.import_module('bauiv1')
        main_dict['bauiv1'] = _mod
        main_dict['bui'] = _mod
        _mod = importlib.import_module('bauiv1lib')
        main_dict['bauiv1lib'] = _mod
        main_dict['bui_lib'] = _mod
