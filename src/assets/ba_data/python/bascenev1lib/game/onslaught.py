...
class OnslaughtGame(bs.CoopGameActivity[Player, Team]):
    ...
    def on_transition_in(self) -> None:
        ...
        if self._preset in {Preset.ROOKIE, Preset.ROOKIE_EASY}:
            ...
            if not customdata.get('_showed_onslaught_landmine_tip', False):
                ...
                self.tips = [
                    bs.GameTip(
                        _classicassets.strings.tips.land_mines_speedy,
                        icon=_classicassets.textures.powerup_land_mines.get(),
                        sound=_builtinassets.audio.ding.get(),
                    )
                ]
        ...
        if self._preset in {Preset.PRO, Preset.PRO_EASY}:
            ...
            if not customdata.get('_showed_onslaught_tnt_tip', False):
                ...
                self.tips = [
                    bs.GameTip(
                        _classicassets.strings.tips.tnt_box,
                        icon=_classicassets.textures.tnt.get(),
                        sound=_builtinassets.audio.ding.get(),
                    )
                ]
        ...
        if self._preset in {Preset.UBER, Preset.UBER_EASY}:
            ...
            if not customdata.get('_showed_onslaught_curse_tip', False):
                ...
                self.tips = [
                    bs.GameTip(
                        _classicassets.strings.tips.curse_boxes,
                        icon=_classicassets.textures.powerup_curse.get(),
                        sound=_builtinassets.audio.ding.get(),
                    )
                ]
        ...
        try:
            if player.is_alive():
                ...
                self.stats.player_scored(
                    ...
                    title=_classicassets.strings.game.flawless_wave,
                    screenmessage=False,
                )
        except Exception:
    ...
    def _update_wave_ui_and_bonuses(self) -> None:
        ...
        tbtcolor = (1, 1, 0, 1)
        tbttxt = _classicassets.strings.game.time_bonus_amount(
        ...
        wtcolor = (1, 1, 1, 1)
        wttxt = _classicassets.strings.game.wave_number(
