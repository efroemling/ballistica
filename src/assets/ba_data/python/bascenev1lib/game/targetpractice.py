    ...
    def do_hit_at_position(self, pos: Sequence[float], player: Player) -> bool:
        ...
        if dist <= self._r3 + self._rfudge:
            ...
            if dist <= self._r1 + self._rfudge:
                ...
                _classicassets.audio.bell_high.get().play()
                if streak > 0:
                    (
                        _classicassets.audio.orchestra_hit4.get()
                        if streak > 3
                        else (
                            _classicassets.audio.orchestra_hit3.get()
                            if streak > 2
                            else (
                                _classicassets.audio.orchestra_hit2.get()
                                if streak > 1
                                else _classicassets.audio.orchestra_hit.get()
                            )
                        )
                    ).play()
                ...
                points = 4
                _classicassets.audio.bell_med.get().play()
            else:
                self._nodes[0].color = cdull
                self._nodes[1].color = cdull
                ...
                points = 2
                _classicassets.audio.bell_low.get().play()
