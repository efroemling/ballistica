...
#
"""Handball game and support classes... by fang :>"""
...
class Puck(bs.Actor):
    ...
    def __init__(self, position: Sequence[float] = (0.0, 1.0, 0.0)):
        ...
        self.node = bs.newnode(
            ...
            delegate=self,
            attrs={
                'mesh': bomb_factory.bomb_mesh, # no puck, get me da bomb
                'color_texture': bomb_factory.sticky_tex,
                'body': 'sphere',
                'reflection': 'soft',
    ...
    def handlemessage(self, msg: Any) -> Any:
        ...
        # If we go out of bounds, move back to where we started.
            ...
            self.node.handlemessage(
                ...
                msg.velocity[1],
                msg.velocity[2],
                2.0 * msg.magnitude, # increase da fkin puck's reaction to explosions...
...
class Handball(bs.TeamGameActivity[Player, Team]):
    """Ice hockey game."""
    ...
    def __init__(self, settings: dict):
        ...
        self.puck_material.add_actions(
            ...
            actions=('modify_part_collision', 'collide', True), # lemme pick up da puck
        )
        self.puck_material.add_actions(
            conditions=(
