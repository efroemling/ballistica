...
class TournamentButton:
    ...
    def __init__(
        ...
        if USE_ENTRY_FEES:
            bui.textwidget(
                ...
                size=(0, 0),
                h_align='center',
                text=_classicassets.strings.coop.entry_fee,
                v_align='center',
                maxwidth=100,
                scale=0.9,
                color=header_color,
        ...
        bui.textwidget(
            ...
            size=(0, 0),
            h_align='center',
            text=_classicassets.strings.coop.prizes,
            v_align='center',
            maxwidth=130,
            scale=0.9,
            color=header_color,
        ...
        self.prize_chest_1_image = bui.imagewidget(
            parent=parent,
            draw_controller=btn,
            texture=_builtinassets.textures.white.get(),
            position=(x + 380 + xo2 + x_offs, y + scly - 93),
        ...
        bui.textwidget(
            ...
            size=(0, 0),
            h_align='center',
            text=_classicassets.strings.coop.current_best,
            v_align='center',
            maxwidth=180,
            scale=0.9,
            color=header_color,
    ...
    def update_for_data(self, entry: dict[str, Any]) -> None:
        ...
        out_of_time_text: str | bui.LangStr = (
            ...
            else _classicassets.strings.coop.of_total(
        ...
        #     bui.imagewidget(
        #         edit=self.image,
        #         texture=_builtinassets.textures.black,
        #         opacity=0.2,
        #     )
        # else:
        ...
        if fee_var is None:
            ...
            if final_fee == 0:
                final_fee_str = _classicassets.strings.ui.free
            else:
