    ...
    def __init__(
        ...
        if self._show_multiplayer:
            ...
            bui.textwidget(
                ...
                text=_classicassets.strings.kiosk.single_player_examples,
                flatness=1.0,
                scale=1.2,
                h_align='center',
                v_align='center',
            ...
            bui.textwidget(
                ...
                transition_delay=tdelay,
                text=(
                    _classicassets.strings.ui.demo
        ...
        bui.textwidget(
            ...
            text=_classicassets.strings.ui.easy,
            scale=1.3,
            h_align='center',
            v_align='center',
        )
        ...
        if bool(False):
            bui.textwidget(
                ...
                position=(self._width * 0.5, self._height + y_extra - 44),
                transition_delay=tdelay,
                text=_classicassets.strings.kiosk.versus_examples,
                flatness=1.0,
                scale=1.2,
                h_align='center',
                v_align='center',
            ...
            bui.textwidget(
                ...
                position=(h, label_height),
                maxwidth=b_width * 0.7,
                text=_classicassets.strings.ui.epic_mode,
                scale=1.3,
                h_align='center',
                v_align='center',
            )
        ...
        if variant is vart.ARCADE:
            self._b7 = bui.buttonwidget(
                ...
                transition_delay=tdelay,
                label=_classicassets.strings.kiosk.full_menu,
