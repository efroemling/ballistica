...
class AllSettingsWindow(bui.MainWindow):
    ...
    def __init__(
        ...
        bui.textwidget(
            ...
            size=(width, 25),
            text=_classicassets.strings.settings.title,
        ...
        self._controllers_button = _button(
            ...
            position=(x, y),
            label=_classicassets.strings.settings.controllers.title,
            call=self._do_controllers,
            texture=_classicassets.textures.controller_icon.get(),
            imgsize=150,
            imgoffs=(-2.0, 2.0),
        )
        x += bwidth + margin
        ...
        self._graphics_button = _button(
            ...
            position=(x, y),
            label=_classicassets.strings.settings.graphics.title,
            call=self._do_graphics,
            texture=_classicassets.textures.graphics_icon.get(),
            imgsize=135,
            imgoffs=(0, 4.0),
        )
        x += bwidth + margin
        ...
        self._audio_button = _button(
            ...
            position=(x, y),
            label=_classicassets.strings.settings.audio.title,
            call=self._do_audio,
            texture=_classicassets.textures.audio_icon.get(),
            imgsize=150,
            color=(1, 1, 0),
        )
        x += bwidth + margin
        ...
        self._advanced_button = _button(
            ...
            position=(x, y),
            label=_classicassets.strings.settings.advanced.title,
            call=self._do_advanced,
            texture=_classicassets.textures.advanced_icon.get(),
            imgsize=150,
            color=(0.8, 0.95, 1),
            imgoffs=(0, 5.0),
        )
