    ...
    def __init__(
        ...
        bui.textwidget(
            ...
            text=(
                ...
                else _classicassets.strings.playlist.playlists
            ),
        ...
        self._lineup_tex = _classicassets.textures.player_lineup.get()
        ...
        self._eyes_mesh = _classicassets.meshes.plastic_eyes_transparent.get()
        ...
        if self._playlist_select_context is None:
            ...
            bui.textwidget(
                ...
                text=_classicassets.strings.play.one_to_four_players,
                h_align='center',
                v_align='center',
                scale=0.83 * scl,
                flatness=1.0,
        ...
        bui.textwidget(
            ...
            position=(hoffs + scl * (-10), v + scl * 95),
            size=(scl * button_width, scl * 50),
            text=_classicassets.strings.play_modes.teams,
            res_scale=1.5,
            maxwidth=scl * button_width * 0.7,
            h_align='center',
            v_align='center',
        ...
        bui.textwidget(
            ...
            position=(hoffs + scl * (-10), v + (scl * 54)),
            size=(scl * button_width, scl * 30),
            text=_classicassets.strings.play.two_to_eight_players,
            h_align='center',
            v_align='center',
            res_scale=1.5,
            scale=0.83 * scl,
        ...
        bui.textwidget(
            ...
            position=(hoffs + scl * (-10), v + scl * 95),
            size=(scl * button_width, scl * 50),
            text=_classicassets.strings.play_modes.free_for_all,
            maxwidth=scl * button_width * 0.7,
            h_align='center',
            v_align='center',
            color=(0.7, 0.9, 0.7, 1.0),
