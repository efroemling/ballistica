...
if TYPE_CHECKING:
    ...
    class StringsCommonGroup:
        ...
        def code_literal(self, *, text: str | LangStr) -> LangStr:
            ...
            ::
                ...
                Verbatim passthrough for code identifiers (button style names
                etc.) on test pages.
        ...
        #:
        #:     English: "Use this as a reference for building UIs with DocUI.
    ...
    class StringsLayoutGroup:
        ...
        #: ::
        #:
        #:     Sample button label repeated across button styles on the
        #:     bounds-tests page.
        #:
        #:     English: "Hello"
        hello: LangStr
    ...
    class StringsNavGroup:
        ...
        #: ::
        #:
        #:     Button loading a page in replace mode (swaps the current page
        #:     instead of pushing).
        #:
        #:     English: "Replace"
        replace: LangStr
        ...
        #: ::
        #:
        #:     Button opening a slow-loading sub-page in browse mode (exercises
        #:     the loading state).
        #:
        #:     English: "Slow Browse"
        slow_browse: LangStr
    ...
    class StringsWebGroup:
        ...
        def came_from_web(self, *, method: str | LangStr) -> LangStr:
            ...
            ::
                ...
                Body text on the web-request test page; {method} is the literal
                HTTP method used.
    ...
    class StringsGroup:
        ...
        ::
            ...
            Strings for the docui-v2 test UI (bauiv1lib.docuitest plus the
            master server's test pages) - a working reference for DocUI
            development.
