...
#ifndef BALLISTICA_UI_ROOT_UI_H_
#define BALLISTICA_UI_ROOT_UI_H_
...
class RootUI {
 ...
 private:
  ...
  Object::Ref<TextGroup> party_button_text_group_;
  Object::Ref<TextGroup> party_size_text_group_;
  int party_size_text_group_num_{-1};
  Object::Ref<TextGroup> start_a_game_text_group_;
  float start_a_game_text_scale_{};
};

}  // namespace ballistica

#endif  // BALLISTICA_UI_ROOT_UI_H_
