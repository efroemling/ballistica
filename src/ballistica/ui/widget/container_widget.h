...
#ifndef BALLISTICA_UI_WIDGET_CONTAINER_WIDGET_H_
#define BALLISTICA_UI_WIDGET_CONTAINER_WIDGET_H_
...
class ContainerWidget : public Widget {
 ...
 protected:
  ...
  void DrawChildren(RenderPass* pass, bool transparent, float x_offset,
 ...
 private:
  ...
  float blue_{0.49f};
  float alpha_{1.0f};
  Object::Ref<TextureData> tex_;
  SystemModelID bg_model_transparent_i_d_{};
  SystemModelID bg_model_opaque_i_d_{};
  ...
  millisecs_t dynamics_update_time_{};
  bool bg_dirty_{true};
  ...
  millisecs_t last_prev_next_time_{};
  ...
  Object::Ref<PythonContextCall> on_outside_click_call_;
  Object::Ref<PythonContextCall> on_cancel_call_;
};

}  // namespace ballistica

#endif  // BALLISTICA_UI_WIDGET_CONTAINER_WIDGET_H_
