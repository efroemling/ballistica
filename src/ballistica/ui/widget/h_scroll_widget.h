...
#ifndef BALLISTICA_UI_WIDGET_H_SCROLL_WIDGET_H_
#define BALLISTICA_UI_WIDGET_H_SCROLL_WIDGET_H_
...
class HScrollWidget : public ContainerWidget {
 public:
  ...
  void HandleRealTimerExpired(RealTimer<HScrollWidget>* t);
 ...
 private:
  ...
  Object::Ref<RealTimer<HScrollWidget> > touch_delay_timer_;
};

}  // namespace ballistica

#endif  // BALLISTICA_UI_WIDGET_H_SCROLL_WIDGET_H_
