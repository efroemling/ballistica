...
void Assets::StartLoading() {
  ...
  LoadBuiltinMesh(
      ...
      "a-0.babuiltinassets.260617:meshes/scroll_bar_thumb_transparent");
  LoadBuiltinMesh(
      BuiltinMeshID::kMeshesScrollBarTroughTransparent,
      "a-0.babuiltinassets.260617:meshes/scroll_bar_trough_transparent");
  LoadBuiltinMesh(BuiltinMeshID::kMeshesShield,
                  "a-0.babuiltinassets.260617:meshes/shield");
  LoadBuiltinMesh(BuiltinMeshID::kMeshesShockWave,
                  "a-0.babuiltinassets.260617:meshes/shock_wave");
  LoadBuiltinMesh(BuiltinMeshID::kMeshesShrapnel1,
                  "a-0.babuiltinassets.260617:meshes/shrapnel1");
  LoadBuiltinMesh(BuiltinMeshID::kMeshesShrapnelBoard,
                  "a-0.babuiltinassets.260617:meshes/shrapnel_board");
  LoadBuiltinMesh(BuiltinMeshID::kMeshesShrapnelSlime,
                  "a-0.babuiltinassets.260617:meshes/shrapnel_slime");
  LoadBuiltinMesh(BuiltinMeshID::kMeshesSoftEdgeInside,
                  "a-0.babuiltinassets.260617:meshes/soft_edge_inside");
  LoadBuiltinMesh(BuiltinMeshID::kMeshesSoftEdgeOutside,
                  "a-0.babuiltinassets.260617:meshes/soft_edge_outside");
  LoadBuiltinMesh(BuiltinMeshID::kMeshesTextBoxTransparent,
                  "a-0.babuiltinassets.260617:meshes/text_box_transparent");
  LoadBuiltinMesh(BuiltinMeshID::kMeshesVrFade,
                  "a-0.babuiltinassets.260617:meshes/vr_fade");
  LoadBuiltinMesh(BuiltinMeshID::kMeshesVrOverlay,
                  "a-0.babuiltinassets.260617:meshes/vr_overlay");
  LoadBuiltinMesh(
      BuiltinMeshID::kMeshesWindowHsmallVmedOpaque,
      "a-0.babuiltinassets.260617:meshes/window_hsmall_vmed_opaque");
  LoadBuiltinMesh(
      BuiltinMeshID::kMeshesWindowHsmallVmedTransparent,
      "a-0.babuiltinassets.260617:meshes/window_hsmall_vmed_transparent");
  LoadBuiltinMesh(
      BuiltinMeshID::kMeshesWindowHsmallVsmallOpaque,
      "a-0.babuiltinassets.260617:meshes/window_hsmall_vsmall_opaque");
  LoadBuiltinMesh(
      BuiltinMeshID::kMeshesWindowHsmallVsmallTransparent,
      "a-0.babuiltinassets.260617:meshes/window_hsmall_vsmall_transparent");
  LoadBuiltinMesh(BuiltinMeshID::kMeshesWing,
                  "a-0.babuiltinassets.260617:meshes/wing");
