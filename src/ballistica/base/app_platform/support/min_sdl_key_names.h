...
#ifndef BALLISTICA_BASE_APP_PLATFORM_SUPPORT_MIN_SDL_KEY_NAMES_H_
#define BALLISTICA_BASE_APP_PLATFORM_SUPPORT_MIN_SDL_KEY_NAMES_H_
...
#endif  // BALLISTICA_BASE_APP_PLATFORM_SUPPORT_MIN_SDL_KEY_NAMES_H_
