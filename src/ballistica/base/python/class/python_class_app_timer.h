...
#ifndef BALLISTICA_BASE_PYTHON_CLASS_PYTHON_CLASS_APP_TIMER_H_
#define BALLISTICA_BASE_PYTHON_CLASS_PYTHON_CLASS_APP_TIMER_H_
...
class PythonClassAppTimer : public PythonClass {
 public:
...
#endif  // BALLISTICA_BASE_PYTHON_CLASS_PYTHON_CLASS_APP_TIMER_H_
