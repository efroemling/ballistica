...
auto PythonMethodsBase1::GetMethods() -> std::vector<PyMethodDef> {
  return {
#if BA_ENABLE_AUTOMATION
    PyAutomationCaptureScreenshotDef, PyAutomationPressAtVirtualDef,
        PyAutomationScrollAtVirtualDef,
#endif
        PyDiscordRequestSignInTokenDef, PyDiscordUpdatePresenceDef,
        PyDiscordAvailableDef, PyDiscordReconnectWithRefreshTokenDef,
        PyAppNameDef, PyAppIsActiveDef, PyRunAppDef, PyAppNameUpperDef,
        PyIsXCodeBuildDef, PyEmitLogDef, PyV1CloudLogDef, PyEnvDef, PyPreEnvDef,
        PyCommitAppConfigDef, PyApplyAppConfigDef, PyQuitDef, PyAppTimerDef,
        PyAppTimeDef, PyDisplayTimeDef, PyDisplayTimerDef, PyPushCallDef,
        PyMusicPlayerShutdownDef, PyMusicPlayerSetVolumeDef,
        PyMusicPlayerPlayDef, PyMusicPlayerStopDef, PyAppInstanceUUIDDef,
        PyUserRanCommandsDef, PyReloadMediaDef, PyReloadChangedMediaDef,
        PyMacMusicAppInitDef, PyMacMusicAppGetVolumeDef,
        PyMacMusicAppSetVolumeDef, PyMacMusicAppStopDef,
        PyMacMusicAppPlayPlaylistDef, PyMacMusicAppGetPlaylistsDef,
        PyIsOSPlayingMusicDef, PyExecArgDef, PyOnAppRunningDef,
        PyOnInitialAppModeSetDef, PyReachedEndOfBaBaseDef, PyUserAgentStringDef,
        PyOnEmptyAppModeActivateDef, PyOnEmptyAppModeDeactivateDef,
        PyEmptyAppModeHandleAppIntentDefaultDef,
        PyEmptyAppModeHandleAppIntentExecDef, PyGetImmediateReturnCodeDef,
        PySetAppExitCodeDef, PyCompleteShutdownDef, PyShutdownSuppressBeginDef,
        PyShutdownSuppressEndDef, PyShutdownSuppressCountDef,
        PyGetDevConsoleInputTextDef, PySetDevConsoleInputTextDef,
        PyDevConsoleInputAdapterFinishDef, PyAudioShutdownBeginDef,
        PyAudioShutdownIsCompleteDef, PyGraphicsShutdownBeginDef,
        PyGraphicsShutdownIsCompleteDef, PyCrashDef,
  };
}
