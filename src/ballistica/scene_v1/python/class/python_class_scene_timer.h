...
#ifndef BALLISTICA_SCENE_V1_PYTHON_CLASS_PYTHON_CLASS_SCENE_TIMER_H_
...
class PythonClassSceneTimer : public PythonClass {
 public:
...
#endif  // BALLISTICA_SCENE_V1_PYTHON_CLASS_PYTHON_CLASS_SCENE_TIMER_H_
