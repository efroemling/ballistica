...
#ifndef BALLISTICA_GRAPHICS_RENDERER_H_
#define BALLISTICA_GRAPHICS_RENDERER_H_
...
#include "ballistica/graphics/mesh/mesh_buffer_vertex_simple_full.h"
#include "ballistica/graphics/mesh/mesh_buffer_vertex_smoke_full.h"
#include "ballistica/graphics/mesh/mesh_buffer_vertex_sprite.h"
...
#include "ballistica/graphics/mesh/mesh_indexed_object_split.h"
#include "ballistica/graphics/mesh/mesh_indexed_simple_full.h"
#include "ballistica/graphics/mesh/mesh_indexed_simple_split.h"
#include "ballistica/graphics/mesh/mesh_indexed_smoke_full.h"
#include "ballistica/graphics/mesh/mesh_indexed_static_dynamic.h"
#include "ballistica/graphics/mesh/mesh_non_indexed.h"
#include "ballistica/graphics/mesh/sprite_mesh.h"
#include "ballistica/graphics/mesh/text_mesh.h"
#include "ballistica/graphics/render_command_buffer.h"
...
class Renderer {
 public:
  ...
  virtual auto NewModelData(const ModelData& model) -> ModelRendererData* = 0;
  virtual auto NewTextureData(const TextureData& texture)
      -> TextureRendererData* = 0;
...
#endif  // BALLISTICA_GRAPHICS_RENDERER_H_
