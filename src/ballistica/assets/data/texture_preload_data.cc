...
void TexturePreloadData::rgba8888_to_rgba4444_in_place(void* src, size_t cb) {
...
void TexturePreloadData::ConvertToUncompressed(TextureData* texture) {
...
TexturePreloadData::~TexturePreloadData() {
